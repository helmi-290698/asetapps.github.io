            ...
            <div class="row align-items-center">
                <div class="col-sm-6">
                    ...
                    <ol class="breadcrumb ">
                        ...
                        <li class="breadcrumb-item active">Data Fisik</li>
                    </ol>
                </div>
        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="card m-b-30">
                    <div class="card-body">
                       <h3> <a href="/tambahfisik" class="btn btn-success btn-lg  mb-2 "> <i class="fa fa-plus"></i> Tambah data</a></h3> 
