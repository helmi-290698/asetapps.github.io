    ...
    <div class="slimscroll-menu" id="remove-scroll">
        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu" id="side-menu">
                ...
                <li>
                    <a href="/category" class="waves-effect"><i class="mdi mdi-ballot"></i><span>Kategori </span></a>
                </li>
               
                <li>
                    <a href="/status" class="waves-effect"><i class="mdi mdi-bulletin-board"></i><span>Status </span></a>
                </li>
                <li>
                    <a href="calendar.html" class="waves-effect"><i class="mdi mdi-account-badge-horizontal"></i><span>Peminjam </span></a>
                </li>
                <li>
